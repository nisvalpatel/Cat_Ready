"""
Django settings for Cat Ready backend.
"""
import os
...
# Load .env from project root so OPENAI_API_KEY is found when running manage.py from any cwd
